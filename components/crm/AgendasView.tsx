...
export function AgendasView({ userName }: { userName?: string }) {
  ...
  return (
    <div className="p-6 h-full overflow-y-auto max-w-5xl mx-auto text-slate-900 dark:text-slate-100">
      ...
      <div className="mb-8">
        <h3 className="text-lg font-semibold text-slate-600 dark:text-slate-400 mb-4 uppercase tracking-wider">
          📅 Para Hoy ({tasksToday.length})
        </h3>
                ...
                <div className="flex items-stretch">
                  ...
                  <div className="flex-1 p-4 flex flex-col justify-center min-w-0">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Badge variant="secondary" className="text-xs dark:bg-slate-800">
                        {task.source}
                      </Badge>
                    </div>
                  </div>
