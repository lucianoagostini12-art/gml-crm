...
import { Search, BookOpen, ShieldAlert, Zap, BrainCircuit, Fingerprint, Loader2 } from "lucide-react"
...
export function WikiView() {
    ...
    useEffect(() => {
        ...
        // ✅ Realtime: si admin agrega/edita/borra, se actualiza solo
        const channel = supabase
            .channel("wiki_resources_realtime")
            .on(
                "postgres_changes",
                { event: "*", schema: "public", table: "wiki_resources" },
                () => {
                    loadWiki()
                }
            )
    ...
    const filteredData = wikiSections
        .map((section) => ({
            ...section,
        ...
        <div className="p-6 h-full overflow-y-auto max-w-5xl mx-auto text-slate-900 dark:text-slate-100 pb-20">
            <div className="mb-8">
                ...
                <p className="text-slate-500 dark:text-slate-400 mb-6 font-medium">
                    Tu manual interactivo para rebatir objeciones y cerrar más ventas.
                </p>
